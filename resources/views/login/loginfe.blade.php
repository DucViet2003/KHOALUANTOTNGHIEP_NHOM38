...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('login/fe/css/style.css')}}">
  ...
  <body>
      ...
      <div class="overlay-container">
        <div class="overlay">
          <div class="overlay-panel overlay-left">
            ...
            <p>Nếu bạn đã đăng kí tài khoản, xin vui lòng chọn vào đây để đăng nhập</p>
          ...
          <div class="overlay-panel overlay-right">
            ...
            <p>
                Nếu bạn chưa có tài khoản, hãy đăng kí ở đây nhé !
            </p>
    ...
    <script src="{{asset('login/fe/js/script.js')}}"></script>
  </body>
</html>
